    ...
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString)
        {
            ...
            /*IQueryable<string> genreQuery = from m in _context.Movie
                                            orderby m.Genre
                                            select m.Genre;*/
            //Don't use distinct here because we want the query to run later and .Distinct here will force it
            IQueryable<string> genreQuery = _context.Movie.OrderBy(m => m.Genre).Select(m => m.Genre);

            var movies = from m in _context.Movie select m;//get all movies
